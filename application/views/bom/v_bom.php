...
<?php if($this->session->userdata('detail') == "Detail"){
    ...
    <a href="<?php echo site_url('BOM/Tambah'); ?>" role="button" class="btn btn-rounded btn-info" style="margin-left: 30%"><i class="fa fa-fw fa-plus-circle"></i>Tambah</a><br><br>

    <!--Tabel-->
    <div align="center">
    <div class="card mb-3" style="width: 40%;">
        <div class="card-header" align="left"><i class="mdi mdi-table"></i> Data Bill of Material</div>
            <div class="card-body">
                <h3 class="text-center">Bill of Material</h3><br>
                        ...
                        <tbody>
                            <?php foreach ($nama as $data) { ?>
                                <tr>
                                    ...
                                    <form method="POST" action="<?php echo site_url('BOM'); ?>">
            ...
            <!-- Modal Detail -->
            <?php if($this->session->userdata('detail') == "Detail"):?>
            <?php foreach ($bom as $data):?>
            <div id="ModalDetail" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">

                        <div class="modal-header">
                            <h4 class="modal-title">BOM <?php echo $data->nama_produk;?></h4>

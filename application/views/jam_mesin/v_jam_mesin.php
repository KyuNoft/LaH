...
<?php if($this->session->userdata('detail') == "Detail"){
    ...
    <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Jam Mesin</li>
                    </ol>
                </div>
                <div>
    ...
    <a href="<?php echo site_url('JamMesin/Tambah'); ?>" role="button" class="btn btn-rounded btn-info" style="margin-left: 30%"><i class="fa fa-fw fa-plus-circle"></i>Tambah</a><br><br>

    <!--Tabel-->
    <div align="center">
    <div class="card mb-3" style="width: 40%;">
        <div class="card-header" align="left"><i class="mdi mdi-table"></i> Data Jam Mesin</div>
            <div class="card-body">
                <h3 class="text-center">Jam Mesin</h3><br>
                        ...
                        <tbody>
                            <?php foreach ($nama as $data) { ?>
                                <tr>
                                    ...
                                    <form method="POST" action="<?php echo site_url('JamMesin'); ?>">
            ...
            <!-- Modal Detail -->
            <?php if($this->session->userdata('detail') == "Detail"):?>
            <?php foreach ($jam_mesin as $data):?>
            <div id="ModalDetail" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">

                        <div class="modal-header">
                            <h4 class="modal-title">Jam Mesin <?php echo $data->nama_produk;?></h4>
